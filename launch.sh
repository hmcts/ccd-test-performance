...
COMPILATION_CLASSPATH=`find -L ./target -maxdepth 1 -name "*fat-tests.jar" -type f -exec printf :{} ';'`
...
java $JAVA_OPTS $USER_ARGS -cp $COMPILATION_CLASSPATH io.gatling.app.Gatling